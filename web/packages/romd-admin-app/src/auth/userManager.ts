...
// Authority is the current origin: in production the admin host serves the SPA, /connect, and
// discovery; in dev Vite proxies /connect and /.well-known to the admin host (see vite.config.ts),
...
/**
 * Returns the current access token for non-React callers (API client, SignalR, downloads).
